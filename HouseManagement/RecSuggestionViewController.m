...
#import "RecSuggestionTableViewCell.h"
#import "AFNetworking.h"
#import "SVProgressHUD.h"
@interface RecSuggestionViewController()
...
@implementation RecSuggestionViewController
...
- (void)viewDidLoad {
    ...
    UINib *nib = [UINib nibWithNibName:@"RecSuggestionTableViewCell" bundle:nil];
    [self.mesTabel  registerNib:nib forCellReuseIdentifier:@"recsuggestion"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    RecSuggestionTableViewCell *cell = [self.mesTabel       dequeueReusableCellWithIdentifier:@"recsuggestion"];
    if(cell==nil){
        cell = [[RecSuggestionTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"recsuggestion"];}
